...
Hi, I'm Kevin Ariza, passionate about programming and web application development.  
...
<img src="https://img.shields.io/badge/AWS-Services-0072B1?style=for-the-badge&logo=amazon-aws&logoColor=white" alt="AWS Badge">

---

## 📂 Skills
- 🚀 Development of dynamic web applications with Angular and Astro.  
- 🗄️ Database modeling and management with SQL and PL/SQL.  
- 🍃 Implementation of NoSQL databases with **MongoDB**.  
- 🔧 API development and business logic with **PHP** and **Python**.  
- 🎨 Responsive UI design with **TailwindCSS** and **Bootstrap**.  
...
💻 Web site: [ingkevinariza.netlify.app](#)
